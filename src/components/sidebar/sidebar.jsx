...
export default function SideBar(){
    return (
        <Box borderRight={1} borderColor='#aaa' width='20%' px={2} pb={2} position='fixed' top='2rem'>
            <Typography component='h1' variant="h5" fontWeight={700} color='#555'>Admin panel</Typography>
            <Box mt={8}>
